...
type SchemaContext = SchemaLink.ResolverContext | SchemaLink.ResolverContextFunction | undefined;
...
export function addApolloState(client: ApolloClient<NormalizedCacheObject> | null, pageProps: {props: any}) {
  if (pageProps?.props) {
